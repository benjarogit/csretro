...
- **Options Mouse (funktional):** NextClient-Controls + `COptionsSubMouse` unter Xash (`look_filter` statt `m_filter`). Smoke: `./scripts/vgui-options-mouse-smoke.sh`. Visueller Gate / Localization-Abschluss offen.
