...
PX1-Research und Port-Matrix: [docs/research/px1-primext.md](research/px1-primext.md). PX2 ist nur die `HUD_GetRenderInterface`-Brücke (`GL_RenderFrame` gibt 0, bis Custom existiert).
