...
1. **Phase 3M** — Mouse/Audio/Video **PASS / Regression** (Brightness/Gamma manueller Recheck offen — `docs/PHASE3M-VIDEO.md`). Keyboard **AUTOMATED PASS / MANUAL RECHECK OPEN**. Adaptive Layout **AUTOMATED PASS / MANUAL ACCEPTANCE OPEN**. Desktop-UI-Optik (Options, Hauptmenü, Create Game, LAN-Browser) ist seit **2026-09-04 visuell abgenommen**. Konsole: **AUTOMATED PASS / MANUAL VISUAL CHECK OPEN**. **Team-Wahl: AUTOMATED PASS / MANUAL VISUAL ACCEPTANCE OPEN**; aktueller Referenzumbau: vollständiger Blur, große echte Studio-Figuren mit AK-47 bzw. schallgedämpfter M4A1 über den nativen Player-`weaponmodel`-Pfad vor CS-Retro-Emblemen, Titel/Counts oben, echte Namen und Teamzahlen mittig, Icon-Footer unten rechts. Das sichtbare T- und CT-Modell wechselt bei jedem Öffnen zwischen den vier vorhandenen Klassen, die Teamwaffe bleibt fest. Der Roster kommt laufend aus Scoreboard/Spectator, umfasst alle 32 Slots und der Gate prüft zusätzlich Umbenennung plus Teamwechsel (2/4 statt 3/3). **Class-Wahl: vier animierte Originalmodelle in einer gemeinsamen Studioszene, direkte `joinclass 1..4`-Flächen, Auto/Cancel; keine statischen `gfx/vgui`-Portraits.** Team- und Class-Gates sind bei 800×600 und 1280×720 grün; die Gate-Namen sind ausschließlich Testdaten, normal werden keine Spieler erfunden. Buy: AUTOMATED PASS + Grundfunktion abgenommen. Radio: AUTOMATED PASS + alle drei getrennten Menüs im Spiel bestätigt. Pause ist abgenommen. Spectator/Scoreboard besitzen abgenommene erste Funktionsscheiben, ihr 1:1-Feinschliff bleibt offen. PlayerList bleibt Stub (`menu_playerlist`). Vollständiger Engine-/Client-/Menü-Neubau 2026-09-06: Exit 0, keine Compilerwarnung und kein Compilerfehler; Ursachen wurden im Code behoben, nicht ausgeblendet. **Kein Phase-3-Tag. FOV/3D gesperrt.**
