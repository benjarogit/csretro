...
**Nächster Schritt:** Spiel vollständig neu starten (Client + Menü). Waffenkarten sind echte texturierte Weltmodelle von der Seite, nicht gelb. Figur = gewählte Klasse (`joinclass`). Nightvision ohne Icon. Flash/HE/Smoke und Vest/Vest+Helm teilen in CS 1.6 weiterhin dasselbe Mesh.
