...
| **Team / Class / Buy** | Wahl- und Kauf-Viewport | Steam-`.res` bleibt Funktion. Team: **zentrierte Bühne** (Titel, Emblem, Studio-Slot, Listen, Footer) — nicht edge-to-edge; pro Öffnen ein anderes vorhandenes T-/CT-Modell. Class: vier echte, animierte Player-Modelle in einer gemeinsamen Studioszene und direkt darüberliegende `joinclass`-Flächen. T trägt jeweils AK-47, CT die schallgedämpfte M4A1. Buy = Kategorie-Raster | Radio-Karte, GameUI-Frame, Orange-ClientScheme, CS2-Waffenkatalog, Steam-Teamkarten, statische Class-Portraits, Vollbild-Leere |
