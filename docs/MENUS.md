...
| **Team / Class / Buy** | Wahl- und Kauf-Viewport | Steam-`.res` bleibt Funktion. Team: **zentrierte Bühne** (Titel, Emblem, Studio-Slot, Listen, Footer) — nicht edge-to-edge. T = `leet.mdl`, CT = `sas.mdl` über die Menü-Playermodel-Preview. Buy = Kategorie-Raster; Class bleibt Team-Familie | Radio-Karte, GameUI-Frame, Orange-ClientScheme, CS2-Waffenkatalog, Steam-Teamkarten, Vollbild-Leere |
