...
private:
	...
	[[maybe_unused]] int				   _mouseSelectCursorStart;	// where mouse button was pressed down in text window
	...
	[[maybe_unused]] bool			   _firstFocusStatus; // keep track if we've had that first focus or not
