...
1. **Phase 3M** — Mouse/Audio/Video **PASS / Regression** (Brightness/Gamma manueller Recheck offen — `docs/PHASE3M-VIDEO.md`). Keyboard **AUTOMATED PASS / MANUAL RECHECK OPEN**. Adaptive Layout **AUTOMATED PASS / MANUAL ACCEPTANCE OPEN**. Desktop-UI-Optik (Options, Hauptmenü, Create Game, LAN-Browser) ist seit **2026-09-04 visuell abgenommen**. Konsole: **AUTOMATED PASS / MANUAL VISUAL CHECK OPEN**. **Team-Wahl: AUTOMATED PASS / MANUAL VISUAL ACCEPTANCE OPEN**; aktueller Referenzumbau: vollständiger Blur, große echte Studio-Figuren mit bone-gemergter Glock/USP vor CS-Retro-Emblemen, Titel/Counts oben, reale Teamlisten mittig, Icon-Footer unten rechts. Gate grün bei 800×600 und 1280×720; die Gate-Namen sind ausschließlich Testdaten, normal werden keine Spieler erfunden. **Class-Wahl: AUTOMATED + Inhaber-Check Namen ok. Buy: AUTOMATED PASS + Grundfunktion abgenommen. Radio: AUTOMATED PASS + alle drei getrennten Menüs im Spiel bestätigt.** Pause ist abgenommen. Spectator/Scoreboard besitzen abgenommene erste Funktionsscheiben, ihr 1:1-Feinschliff bleibt offen. PlayerList bleibt Stub (`menu_playerlist`). Der historische Compiler-Warnungsbestand bleibt sichtbar und wird blockweise ursächlich behoben; nicht als „0 Warnungen“ bezeichnen oder ausblenden. **Kein Phase-3-Tag. FOV/3D gesperrt.**
