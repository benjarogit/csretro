...
// CS Retro: Xash 60 capped the 102 client request and reproduced the shoot hitch.
CVAR_DEFINE_AUTO( sv_maxupdaterate, "102.0", FCVAR_ARCHIVE, "maximal value for 'cl_updaterate' window, 0 == unlimited" );
