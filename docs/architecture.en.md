...
│   └── PrimeXT-derived tech (`client/render/`; PX3B world/BSP, PX3C entity/sprite, PX4A non-player studio, PX4B.1 FOLLOW, #7 brush special A/B/C + engine EFX draw-only)
