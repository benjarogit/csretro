...
void CBaseParticle::Draw()
{
	...
	Vector lowLeft = m_vOrigin - (width * 0.5) - (up * radius * 0.5);

	Vector lowRight = lowLeft + width;
	Vector topLeft = lowLeft + height;
	Vector topRight = lowRight + height;
