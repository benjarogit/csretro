...
| 3D NextClient-Features | **nach 3M** — erstes Feature FOV, nur nach Freigabe. Danach u. a. individuelles Crosshair (NextClient-Basis, feiner als Presets) und Radar-Minimap (Karte im Radar; MetaHook/GameBanana nur Abguck, NextClient hat keins). `docs/PHASE3M.md` |
