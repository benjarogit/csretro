...
- Erste produktive Integration PX2: nur Render-API-Brücke (`17bd79f`, visuell verifiziert, Issue #4 geschlossen). PX3B: gezielte World/Offscreen-Adaption in `client/render/` (`GL_RenderFrame` bleibt 0). Siehe `docs/research/px1-primext.md`.
