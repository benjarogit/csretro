...
- **Buy-Kacheln und Waffen-Silhouetten (Inhaber 2026-09-08):** Waffenkarten richten `w_*.mdl` nicht mehr per Euler aus. Die Engine liest die GoldSrc-Idle-Box und mappt die dünnste Achse auf den Blick, die längste waagerecht, plus Flatten der Dicke — goldenes Seitenprofil (AK-Magazin/Schaft, AWP-Lauf/Zielfernrohr) statt Diagonal-Klecks. Kachel-Layout wie CS:GO-Referenz: Nummer links, Name oben links, Silhouette füllt die Mitte, Preis unten rechts, dünner Rahmen, Hover helleres Grau. Playermodel-Pfad (`SetPreview`) unangetastet. CS-1.6-Katalog, keine TGA. Manuelle Abnahme Buy offen.
