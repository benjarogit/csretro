...
// CS Retro: Xash 20/30 felt like a hitch on listen (cmdrate applies if maxclients>1).
CVAR_DEFINE_AUTO( cl_updaterate, "102", FCVAR_USERINFO|FCVAR_ARCHIVE, "refresh rate of server messages" );
CVAR_DEFINE_AUTO( cl_showevents, "0", FCVAR_ARCHIVE, "show events playback" );
CVAR_DEFINE_AUTO( cl_cmdrate, "100", FCVAR_ARCHIVE, "Max number of command packets sent to server per second" );
...
CVAR_DEFINE_AUTO( rate, "100000", FCVAR_USERINFO|FCVAR_ARCHIVE|FCVAR_FILTERABLE, "player network rate" );
