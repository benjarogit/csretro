...
| **3M VGUI2 / Desktop-UI** | **in Arbeit** — Mouse/Audio/Video **PASS / Regression**; Keyboard **AUTOMATED PASS / MANUAL RECHECK OPEN**; Adaptive Layout / Resize **AUTOMATED PASS / MANUAL OPEN**; bestehende Desktop-UI-Optik **vom Inhaber abgenommen (2026-09-04)**; VGUI2-Konsole **AUTOMATED PASS / MANUAL CHECK OPEN**; Team **AUTOMATED + visuell bestätigt 2026-09-07**; Class **AUTOMATED + visuell bestätigt 2026-09-07**; Buy funktional, **Look 2026-09-07 abgelehnt**; Radio funktional abgenommen; Pause funktional und optisch abgenommen; Spectator und Scoreboard funktional sowie in ihrer ersten Look-Scheibe abgenommen. FOV gesperrt. `docs/PHASE3M.md`, `docs/PHASE3M-KEYBOARD.md`, `docs/PHASE3M-LAYOUT.md` |
...
| Utility HE/Flash/Smoke | **nach 3M**, nicht in 3M. Zielbild `docs/UTILITY.md`. Wurf + Inferno schon da (`docs/INFERNO.md`). Erste Scheibe: HE-Deckung/Tagging, dann Flash, dann Smoke-Zellen. |
