...
extern cvar_t csretro_fire_debug;
...
extern cvar_t announcer_countdown;
extern cvar_t announcer_minute;
extern cvar_t announcer_warmup;
extern cvar_t announcer_warmup_limit;
