...
| https://github.com/languagelawyer/cs16-client/tree/molotov | GoldSrc-Molotov-Experiment (Client). **Funktion 2026-09-11:** Pin-Semantik/Tempents abgeguckt. **Viewmodels nicht übernommen** (Inhaber 09:05: Zippo/Fire-Pack bleiben). Skript liegt unter `scripts/build_molotov_models.py`, Import wendet es nicht an. ID 2 nicht übernommen — 32/33 |
| https://github.com/languagelawyer/ReGameDLL_CS/tree/molotov | Dasselbe Experiment serverseitig. **Nur Abschauen:** Surface-Samples/CVars/Downhill-Drip **nicht** übernommen (unsere Inferno-Zahlen bleiben CS2-Stand: 32 DPS, 16 Nodes, Spacing 42). Tempents für Sichtbarkeit nativ nachgebaut. Inhaber 11:03: von der Feuer-Simulation dort nichts weiter kopieren |
| https://github.com/languagelawyer/mainui_cpp/tree/molotov | Equipment-Menüeintrag Taste 9. **Nicht übernommen:** unser Buy ist VGUI2 |
...
- **`cstrike15_src`** — Counter-Strike: Global Offensive (`cstrike15`). Radar/Team über Scaleform (`game/client/cstrike15/Scaleform/HUD/sfhudradar.*`, `teammenu_scaleform.*`); Reste von VGUI-`game_controls/buymenu`. Hinweisdatei: Depot 730 vor Hydra (18. Mai 2017). Kein CS2/Source-2. Granaten wie alles andere: vergleichen, Bestes nativ — Peek-Karte `docs/UTILITY.md`. Nicht vendorn.
...
| languagelawyer ReGameDLL molotov | Branch `molotov`, gelesen 2026-09-11 | Nur sichtbare GoldSrc-Tempents (`TE_SPRITE`/`TE_DLIGHT`) am Inferno-Start/Node. **Nicht** deren DPS-CVars, ID 2, 20-Sample-Controller oder HE-only-Wurf | 2026-09-11 |
| languagelawyer cs16-client molotov | Branch `molotov`, 2026-09-11 | Skript lokal kopiert. **Nicht** auf Runtime-MDLs angewandt (Inhaber: Modelle nicht tauschen). Tempents ja. **Nicht** ID 2, mainui-Taste 9, deren Inferno | 2026-09-11 |
