...
1. **Phase 3M** — Mouse/Audio/Video **PASS / Regression** (Brightness/Gamma manueller Recheck offen — `docs/PHASE3M-VIDEO.md`). Keyboard **AUTOMATED PASS / MANUAL RECHECK OPEN**. Adaptive Layout **AUTOMATED PASS / MANUAL ACCEPTANCE OPEN**. Desktop-UI-Optik (Options, Hauptmenü, Create Game, LAN-Browser) ist seit **2026-09-04 visuell abgenommen**. Konsole: **AUTOMATED PASS / MANUAL VISUAL CHECK OPEN**. **Team-Wahl: AUTOMATED PASS / MANUAL VISUAL ACCEPTANCE OPEN**; aktueller Referenzumbau: vollständiger Blur, echte Studio-Figuren mit AK-47 bzw. schallgedämpfter M4A1 über den nativen Player-`weaponmodel`-Pfad vor CS-Retro-Emblemen, Titel/Counts oben, echte Namen und Teamzahlen mittig, Icon-Footer unten rechts. Das sichtbare T- und CT-Modell wechselt bei jedem Öffnen zwischen den vier vorhandenen Klassen, die Teamwaffe bleibt fest. Der Roster kommt laufend aus Scoreboard/Spectator, umfasst alle 32 Slots und der Gate prüft zusätzlich Umbenennung plus Teamwechsel (2/4 statt 3/3). Die Bühne ist auf großen Viewports auf 1440 Pixel Breite begrenzt und zentriert. **Class-Wahl: vier animierte Originalmodelle in einer gemeinsamen Studioszene, direkte `joinclass 1..4`-Flächen, Auto/Cancel; keine statischen `gfx/vgui`-Portraits.** Buy nutzt eine zentrierte Arbeitsfläche bis 1440×810, echte Bildseitenverhältnisse und unter 900 Pixel einen kompakten Vollbreitenmodus ohne große Figur/Detailfläche. Team, Class und Buy sind automatisiert bei 640×480, 800×600, 1280×720 und 2560×1080 grün; Team/Buy zusätzlich bei 1920×1080. Die Gate-Namen sind ausschließlich Testdaten, normal werden keine Spieler erfunden. Buy: Grundfunktion abgenommen, neuer visueller Feinschliff wartet auf den Inhaber-Test. Radio: AUTOMATED PASS + alle drei getrennten Menüs im Spiel bestätigt. Pause ist abgenommen. Spectator/Scoreboard besitzen abgenommene erste Funktionsscheiben, ihr 1:1-Feinschliff bleibt offen. PlayerList bleibt Stub (`menu_playerlist`). Vollständiger Engine-/Menü-Neubau 2026-09-07: Exit 0; Ursachen wurden im Code behoben, nicht ausgeblendet. **Kein Phase-3-Tag. FOV/3D gesperrt.**
