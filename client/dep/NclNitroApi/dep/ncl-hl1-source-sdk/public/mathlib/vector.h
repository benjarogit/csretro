...
public:
	...
	VectorByValue& operator=(const VectorByValue& vOther)
	{
		Vector::operator=(vOther);
		return *this;
	}
};
...
public:
	...
	QAngleByValue& operator=(const QAngleByValue& vOther)
	{
		QAngle::operator=(vOther);
		return *this;
	}
};
...
//-----------------------------------------------------------------------------
#ifndef VECTOR_NO_SLOW_OPERATIONS
inline QAngle::QAngle(const QAngle &vOther)
{
	CHECK_VALID(vOther);
	x=vOther.x; y=vOther.y; z=vOther.z;
}
