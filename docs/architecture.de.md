...
│   └── PrimeXT-derived Technik (`client/render/`; PX3B World/BSP, PX3C Entity/Sprite, PX4A Non-Player Studio, PX4B.1 FOLLOW, #7 Brush Special A/B/C + Engine-EFX + Client-Triangles draw-only)
