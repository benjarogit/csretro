...
**Status: VISUAL ACCEPTED 2026-09-04** für Hauptmenü, Options, Create Game und LAN-Server-Browser. Team ist visuell bestätigt; Class-Namen und erste Look-Scheiben von Team/Class/Buy sowie Spectator/Scoreboard sind abgenommen, ihr Feinschliff folgt später. Die neue Konsole braucht noch ihren manuellen visuellen Check. Neue Dialoge müssen dieselbe Baseline übernehmen; die abgenommene Grundgestaltung wird nicht ohne konkreten neuen Befund erneut aufgerollt.
