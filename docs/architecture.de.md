...
│   └── PrimeXT-derived Technik (`client/render/`; PX2-Brücke, PX3B World offscreen)
...
PX1-Research und Port-Matrix: [docs/research/px1-primext.md](research/px1-primext.md). PX2 (`17bd79f`) ist die `HUD_GetRenderInterface`-Brücke. PX3A: Strategie C. PX3B: World/Offscreen in `client/render/`, `GL_RenderFrame` bleibt 0. Sichtbarer Takeover erst nach Entity/EFX/Studio-Besitz (PX3C/PX4).
