...
**Nächster Schritt:** Spiel vollständig neu starten (Client + Menü + Engine). Waffenkarten: goldene **Seiten**-Silhouetten (Lauf/Magazin/Griff lesbar), nicht Kleckse von oben. Figur rechts = eigene Klasse, dreiviertel zur Kamera wie Team-CT rechts / Class-Lineup. Danach visuell gegen die CS:GO-Referenz prüfen.
