...
- **Buy-Menü (Inhaber 2026-09-07 abgelehnt, Referenzumbau aktiv):** `TEMP_EXTRA/cstrike15_src` und `TEMP_EXTRA/hl2_src` wurden für Zustands-/Lifecycle-Verträge gelesen; die sichtbare CS:GO-Scaleform-Komposition liegt dort nicht als editierbares Layout vor und wird deshalb nativ nach dem Referenzbild rekonstruiert. Die Hauptseite verwendet eine zentrierte 1280×720-Bühne mit begrenzter Skalierung, nummerierten Kategorien/Produkten, einzeln gerahmten Karten, Blur, Footer und großer rechter MDL-Figur. Geld und Buy-Time kommen aus dem echten Client-HUD. Die Einzel-Figur nutzt einen vom lokalen Netzwerkspieler getrennten Studio-Zustand: feste Dreiviertelansicht, korrekte Rifle-Referenzsequenz und natives `p_ak47`-/`p_m4a1`-Bone-Merge; alle vier T-Modelle wurden erzwungen gegengeprüft. Kaufkarten rendern weiterhin ausschließlich `w_*.mdl`; ein menüspezifischer Studio-Farbpfad macht deren echte Geometrie als goldene Silhouette lesbar, ohne TGA, Sprite oder GlowShell. Kurze Produktnamen und getrennte Text-/Modellzonen verhindern Quetschen. Auf kleinen Viewports bleiben Raster und Figur proportional nebeneinander sichtbar. Der visuelle Gate öffnet keine alte Pistolen-Unterseite mehr, sondern prüft den direkten Glock-Kauf im gemeinsamen Raster. Tests: 800×600, 1280×720 und 1920×1080 sowie Live-Resize 1024×768→1280×720; Team/Class-Regression grün. `cstrike/gfx/vgui` bleibt amputiert. Kein CS2-Katalog und kein importierter Source-/Scaleform-Code. Manuelle visuelle Abnahme bleibt offen.
