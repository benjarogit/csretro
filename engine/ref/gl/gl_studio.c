...
GoldSrc w_*.mdl lie in a thin AABB (Z is typically ~2 units). Map that plane
onto the Class/Team picture plane (look along +X) and squash the thin axis so
perspective cannot turn the pickup into a blob. Sequence bbox is read at the
GoldSrc file offset; the in-memory mstudioseqdesc_t layout is not used.
====================
*/
