...
- **Buy-Menü (Inhaber 2026-09-07 abgelehnt, Nachzug):** Desktop-Hauptmenü wird während Team/Class/Buy/Radio ausgeblendet. Steam-Kategorie-Buttons der `.res` bleiben unsichtbar und off-screen, damit kein „Sub-Ma“ über dem Raster liegt. `w_*.mdl` werden pro Waffentyp gerahmt (Pistolen näher, Gewehre weiter), die Studiofigur nutzt dieselbe Kamera-Yaw/Sequenz wie die abgenommene Team-Wahl und steht nicht mehr in einer schwarzen Box. Team/Class visuell nicht angefasst. Kein CS2-Katalog. Manuelle Abnahme des Kaufmenüs bleibt offen.
