...
│   └── PrimeXT-derived Technik (`client/render/`; PX3B World/BSP, PX3C Entity/Sprite, PX4A Non-Player Studio, PX4B.1 FOLLOW, PX4B.2 Remote-Player Variante B, PX4B.3 Local Eligibility + Player Shadows, PX4C.1 Viewmodel BODY VERIFIED, #7 Brush Special A/B/C/D/E complete + Engine-EFX + Client-Triangles draw-only)
