...
Scheme
{
	...
	Colors
	{
		...
		"Black"				"0 0 0 255"
		"ChromeGlass"		"104 106 102 238"
		"ChromeGlassDim"	"86 88 84 226"
		"ChromeBorder"		"225 228 220 142"
		"ChromeInnerBorder"	"218 222 214 96"
		"ChromeHairline"	"218 222 214 64"
		"ChromeControl"		"58 60 56 156"
		"ChromeControlDark"	"38 40 36 150"
		"ChromeControlHover"	"88 91 84 156"
	...
	BaseSettings
	{
		...
		Border.Bright					"ChromeBorder"	// the lit side of a control
		Border.Dark						"ChromeInnerBorder"		// the dark/unlit side of a control
		Border.Selection				"0 0 0 255"			// the additional border color for displaying the default/selected button

		Button.TextColor				"White"
		Button.BgColor					"ChromeControl"
		Button.ArmedTextColor			"White"
		Button.ArmedBgColor				"Blank"
		Button.DepressedTextColor		"White"
		Button.DepressedBgColor			"ChromeControlDark"
		...
		Frame.BgColor					"ChromeGlass"
		Frame.OutOfFocusBgColor			"ChromeGlassDim"
		...
		FrameTitleButton.CloseHoverBgColor	"194 68 52 205"
		FrameTitleButton.ClosePressedBgColor	"150 42 34 225"
		FrameTitleButton.CloseEdgeColor	"255 255 255 72"
		...
		ListPanel.TextBgColor				"ChromeControl"
		ListPanel.BgColor					"ChromeControl"
		...
		ProgressBar.BgColor				"ChromeControl"

		PropertySheet.TextColor			"OffWhite"
		PropertySheet.SelectedTextColor	"Orange"
		PropertySheet.TabBgColor		"34 36 33 62"
		PropertySheet.TabArmedBgColor	"88 91 84 128"
		PropertySheet.TabActiveBgColor	"72 75 69 156"
		PropertySheet.TabEdgeColor	"ChromeHairline"
		PropertySheet.TabAccentColor	"Orange"
		...
		RichText.BgColor				"ChromeControl"
		...
		ScrollBarButton.ArmedBgColor			"ChromeControlHover"
		ScrollBarButton.DepressedFgColor		"White"
		ScrollBarButton.DepressedBgColor		"ChromeControlDark"
		ScrollBarButton.EdgeColor			"ChromeHairline"

		ScrollBarSlider.Inset				1			// Number of pixels to inset scroll bar nob
		ScrollBarSlider.FgColor				"ChromeControl"			// nob color
		ScrollBarSlider.BgColor				"ChromeControlDark"	// slider background color
		...
		SectionedListPanel.BgColor			"ChromeControl"
		...
		TextEntry.BgColor			"ChromeControl"
	...
	{
        Default         FlatBorder
        InsetBorder     FlatBorder
		BaseBorder		FlatBorder
		ButtonBorder	RaisedBorder
		ComboBoxBorder	FlatBorder
		MenuBorder		RaisedBorder
		BrowserBorder	FlatBorder
		PropertySheetBorder	  FlatBorder
		DepressedButtonBorder FlatBorder
