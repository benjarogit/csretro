...
- First productive integration is PX2: render-API bridge only (`17bd79f`, visually verified, issue #4 closed). PX3B: targeted world/offscreen adaptation in `client/render/` (`bbe418d`, visually certified, issue #5 closed, `GL_RenderFrame` stays 0). See `docs/research/px1-primext.md`.
