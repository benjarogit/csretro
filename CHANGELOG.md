...
- **Metrics-/Classic-Gate (Diagnose):** `docs/PHASE3M-METRICS-DIAGNOSIS.md`. Classic-ProportionalBase wieder **640×480** (HD-Umschaltung zurückgenommen). Current Steam BuildMode buildid **12934623** ≠ Golden Visual **5971**. Options-Baum `IsProportional=0`. Loc-Pin Mouse. `mainui.cfg`-Warnung entfernt. Video gesperrt.
